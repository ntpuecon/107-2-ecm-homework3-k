...
在政策執行後比較兩市老人行動力，在沒有控制其他條件下，即使發現北市老人行動力較高，我們也無法做出北是老人“較健康”的結論。因為北市老人行動力較高，可能來自“所得”的影響。一般我們會認為台北市的家庭平均可支配所得較高，這可能會導致市是老人較常出去旅行，故可能會產生他們較健康的錯覺。因此會造成$\beta^*$的估計產生偏誤。
...
Ans：
因為$y_{st,i}$會受到時間影響，但此處僅把地區的固定效果獨立出來，政策前後時間差異可能代表其他非政策的影響。故不法確保立足點與效應解釋變數獨立，所以$\hat{\beta}$不具有一致性。
\
\
...
Ans：
因為$y_{st,i}$會受到地區影響，但此處僅把時間的固定效果獨立出來，政策前後時間差異可能代表其他非政策的影響。故不法確保立足點與效應解釋變數獨立，所以$\hat{\beta}$不具有一致性。
\
\
